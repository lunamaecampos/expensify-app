...
var AddOption = function (_React$Component2) {
  ...
  _createClass(AddOption, [{
    ...
    value: function handleAddOption(value) {
      ...
      var option = value.target.elements.option.value.trim();
...
_reactDom2.default.render(_react2.default.createElement(IndesicionApp, null), document.getElementById('app'));
